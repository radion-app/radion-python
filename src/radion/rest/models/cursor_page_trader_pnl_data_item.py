...
T = TypeVar("T", bound="CursorPageTraderPnlDataItem")


@_attrs_define
class CursorPageTraderPnlDataItem:
    """
    Attributes:
        address (str):
        realized_pnl (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cursor_page_trader_pnl_data_item = cls(
            address=address,
        ...
        cursor_page_trader_pnl_data_item.additional_properties = d
        return cursor_page_trader_pnl_data_item
